...
SECTOR_SPECS: list[SectorSpec] = [
    SectorSpec(
        ...
        instruction=(
            ...
            "CRITICAL ANTI-REFUSAL: You have working search tools. After step 1 "
            "(serper) you WILL receive 10 weather-site URLs and snippets. "
            "Synthesize the weather string from THAT search output. The phrases "
            "'I am not able to', 'I cannot', 'I\'m unable', 'as an AI', "
            "'as a language model', and 'I do not have access' are FORBIDDEN "
            "in the response — schema._cap strips any output starting with those "
            "prefixes (see jeeves/schema.py:_REFUSAL_PREFIXES), losing the weather "
            "section entirely. If after all six steps you genuinely have no data, "
            "return exactly one bare line: 'Weather data unavailable for today.' "
            "Do NOT prefix it with a refusal phrase. Do NOT fabricate specific "
            "temperatures, precipitation amounts, or wind speeds. Do NOT include "
            "the word 'estimate' — either synthesize from real search results "
            "or admit unavailability in that exact bare form."
        ),
        default="",
