...
<state>
branch: sprint-17-write-nim-or-fallback | sprint: 17 (write tier-3 fallback + TPM bloat fix) | date: 2026-05-04 | tests: 280 touched-file tests passing (pre-existing llama_index sandbox failures unchanged)
